...
//This class is created for Portrait view
//portrait_layout.xml is mapped with this java class
...
public class PortraitClass extends Fragment
{
    ...
    {
        return inflater.inflate(R.layout.portrait_layout,container,false);
